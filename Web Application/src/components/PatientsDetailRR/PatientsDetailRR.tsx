...
import classes from './PatientsDetailRR.module.css';
...
import { Vector26Icon } from './Vector26Icon.js';
...
/* @figmaId 176:564 */
export const PatientsDetailRR: FC<Props> = memo(function PatientsDetailRR(props = {}) {
  ...
  return (
    <div className={`${resets.storybrainResets} ${classes.root}`}>
      ...
      <div className={classes.respiration}>Respiration</div>
      ...
      <a href='/patients-rr/' className={classes.respiration2}>Respiration</a>
      ...
      <div className={classes._202}>20</div>
      ...
      <div className={classes.brPM}>BrPM</div>
      ...
      <div className={classes.respirationRate}>Respiration Rate</div>
      ...
      <div className={classes.respirationRate2}>Respiration Rate</div>
      <div className={classes.brpm}>brpm</div>
      ...
      <div className={classes.vector26}>
        <Vector26Icon className={classes.icon17} />
      </div>
    </div>
  );
});
