...
import classes from './PatientsDetailTemp.module.css';
...
/* @figmaId 176:792 */
export const PatientsDetailTemp: FC<Props> = memo(function PatientsDetailTemp(props = {}) {
  ...
  return (
    <div className={`${resets.storybrainResets} ${classes.root}`}>
      ...
      <div className={classes.bodyTemperature}>Body Temperature</div>
      ...
      <a href='/patients-temp/' className={classes.bodyTemp}>Body Temp</a>
      ...
      <div className={classes._372}>37.2</div>
      <div className={classes._367}>36.7</div>
      <div className={classes.min}>Min</div>
      <div className={classes._378}>37.8</div>
      ...
      <div className={classes._35}>35</div>
      ...
      <div className={classes.C}>
        <p className={classes.labelWrapper2}>
          ...
          <span className={classes.label3}>C</span>
        </p>
      </div>
      ...
      <div className={classes.bodyTemperature2}>Body Temperature</div>
      ...
      <div className={classes.vector24}>
        <Vector24Icon className={classes.icon17} />
      </div>
    </div>
  );
});
