...
import classes from './AddPatientMedicalHistory1.module.css';
...
/* @figmaId 375:292 */
export const AddPatientMedicalHistory1: FC<Props> = memo(function AddPatientMedicalHistory1(props = {}) {
  return (
    <div className={`${resets.storybrainResets} ${classes.root}`}>
      ...
      <div className={classes.mdiRegisterOutline}>
        <MdiRegisterOutlineIcon className={classes.icon2} />
      </div>
