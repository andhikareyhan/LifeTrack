...
import classes from './Set_TypeAppearanceStateInactiv.module.css';
...
/* @figmaId 737:1895 */
export const Set_TypeAppearanceStateInactiv: FC<Props> = memo(function Set_TypeAppearanceStateInactiv(props = {}) {
  const handleClick = () => {
    if (props.link) {
